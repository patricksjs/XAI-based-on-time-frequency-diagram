...
class TimeSeriesDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # spectrogram
        f, t, spectrogram = stft(data, fs=self.args.fs, nperseg=self.args.nperseg, noverlap=self.args.noverlap,
                                 boundary='zeros')
...
def load_data(data_name, args):
    ...
    if data_name == "toydata_final":
        ...
        # Read the file into a DataFrame using space as the separator
        file_path = r"C:\Users\34517\Desktop\zuhui\论文\ArrowHead_TRAIN.txt"
        file_path2 =  r"C:\Users\34517\Desktop\zuhui\论文\ArrowHead_TEST.txt"
        df = pd.read_csv(file_path, header=None, delim_whitespace=True)
        df2 = pd.read_csv(file_path2, header=None, delim_whitespace=True)
